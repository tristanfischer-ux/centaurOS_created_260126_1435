    ...
    return (
        <section className="relative min-h-screen flex items-center justify-center bg-background overflow-hidden blueprint-grid">
            ...
            <div className="relative z-10 max-w-5xl mx-auto px-6 text-center transform -translate-y-12">
                {/* Status Badge */}
                <div className="inline-flex items-center gap-2 mb-8 px-4 py-2 bg-background tech-border rounded-full shadow-sm">
                ...
                {/* Main Headline */}
                <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black text-foreground leading-[0.9] tracking-tight mb-8 font-sans">
                ...
                {/* Tagline */}
                <p className="text-muted-foreground text-lg md:text-xl font-light max-w-3xl mx-auto leading-relaxed mb-12 font-sans">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                    ...
                    <Link
                        href="/join/general"
                        className="min-w-[160px] bg-background tech-border text-foreground px-8 py-4 text-xs font-mono tracking-widest uppercase hover:border-international-orange hover:text-international-orange transition-all duration-300"
                    >
                        Join Up
                    </Link>
                </div>
