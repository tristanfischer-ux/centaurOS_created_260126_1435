...
const STATUS_CONFIG: Record<ExecutionStatus, {
    ...
    running: {
        border: "ring-2 ring-status-info/60",
        badge: "Running",
        badgeBg: "bg-status-info-light",
        badgeText: "text-status-info-dark",
        icon: Loader2,
        animate: "animate-pulse",
    },
    review: {
        border: "ring-2 ring-status-warning/60",
        badge: "Review",
        badgeBg: "bg-status-warning-light",
        badgeText: "text-status-warning-dark",
        icon: Eye,
    },
    approved: {
        border: "ring-2 ring-status-success/60",
        badge: "Approved",
        badgeBg: "bg-status-success-light",
        badgeText: "text-status-success-dark",
        icon: Check,
    },
    error: {
        border: "ring-2 ring-status-error/60",
        badge: "Error",
        badgeBg: "bg-status-error-light",
        badgeText: "text-status-error-dark",
        icon: AlertOctagon,
    },
}
