/**
 * scripts/lib/orchestrator/tools/blood-pump-sizing.ts
 *
 * TypeScript wrapper for `blood_pump_sizing.py` — subprocess to repo .venv.
 *
...
const PYTHON_SCRIPT = resolve(__dirname, 'python', 'blood_pump_sizing.py')
const VENV_PYTHON = resolve(__dirname, '..', '..', '..', '..', '.venv', 'bin', 'python3')

export const bloodPumpSizingTool: Tool<any, any> = {
  id: 'blood-pump:sizing',
  name: 'Blood Pump Hemolysis Sizing',
  version: '1.0.0',
...
registerTool(bloodPumpSizingTool)
