                        ...
                        {imageUrls.map((url, index) => (
                            <div key={index} className="relative group">
                                ...
                                <button
                                    ...
                                    className="absolute -top-2 -right-2 w-5 h-5 rounded-full bg-destructive text-destructive-foreground flex items-center justify-center sm:opacity-0 sm:group-hover:opacity-100 transition-opacity"
                                >
                                    <X className="w-3 h-3" />
                                </button>
                            </div>
