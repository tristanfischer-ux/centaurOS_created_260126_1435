...
/**
 * Integrated marketing page — single narrative arc.
 *
 * INTENT: Previous version concatenated two page styles. This version
 * tells one story: Problem -> Solution (with photos and personality
...
/* ═══════════════════════════════════════════════════════════════════════════
 * THE PROBLEM — Software vs Hardware mismatch (unchanged)
 * ═══════════════════════════════════════════════════════════════════════ */
 ...
 *
 * DECISION: Merged the old Cloud Factory abstract cards with the old
 * PEOPLE/NETWORK photo cards. Each pillar now has an image, a headline,
 * and a founder-voice quote — telling the story once with personality.
 * ═══════════════════════════════════════════════════════════════════════ */
 ...
 *
 * DECISION: Replaced 9 large image cards (THE PEOPLE + THE NETWORK +
 * THE OS) with 6 compact icon cards. Same information, one third the
 * space, no visual style clash, all audiences treated equally.
 * ═══════════════════════════════════════════════════════════════════════ */
