...
function getStatusConfig(status: BookingStatus) {
    switch (status) {
        case 'draft':
            return { label: 'Draft', color: 'bg-muted text-foreground', borderColor: 'border-l-border', icon: Clock }
        case 'pending_payment':
            return { label: 'Pending Payment', color: 'bg-status-warning-light text-status-warning-dark', borderColor: 'border-l-status-warning', icon: Clock }
        case 'confirmed':
            return { label: 'Confirmed', color: 'bg-status-info-light text-status-info-dark', borderColor: 'border-l-status-info', icon: CheckCircle }
        case 'in_progress':
            return { label: 'In Progress', color: 'bg-status-success-light text-status-success-dark', borderColor: 'border-l-status-success', icon: Clock }
        case 'completed':
            return { label: 'Completed', color: 'bg-status-success-light text-status-success-dark', borderColor: 'border-l-status-success', icon: CheckCircle }
        case 'cancelled':
            return { label: 'Cancelled', color: 'bg-muted text-muted-foreground', borderColor: 'border-l-border', icon: XCircle }
        case 'disputed':
            return { label: 'Disputed', color: 'bg-status-error-light text-destructive', borderColor: 'border-l-destructive', icon: AlertCircle }
        default:
            return { label: status, color: 'bg-muted text-foreground', borderColor: 'border-l-border', icon: Clock }
    }
}
...
export function OrderSummaryCard({
    ...
    return (
        <Card className={cn("hover:shadow-md transition-all duration-200 border-l-4", statusConfig.borderColor, className)}>
