-- Fix get_daily_pulse search_path
-- This function was missed in the 20260219230000 bulk fix.
-- Without SET search_path = public, the SECURITY DEFINER function
-- cannot resolve the profiles table, causing error 42P01.
