                            ...
                            <div key={objective.id} className="border border-slate-200 rounded-lg overflow-hidden bg-white">
                                ...
                                <div>
                                    {objectiveTasks.map(task => (
                                        <div key={task.id} className="pl-12 pr-6 py-3 border-b border-slate-100 last:border-0 hover:bg-slate-50 flex items-center justify-between group gap-4 relative">
                        ...
                        <div className="border border-slate-200 rounded-lg overflow-hidden bg-white">
                            ...
                            <div>
                                {orphanedTasks.map(task => (
                                    <div key={task.id} className="px-6 py-3 border-b border-slate-100 last:border-0 hover:bg-slate-50 flex items-center justify-between group gap-4">
                                        <div className="flex-1 min-w-0">
                                            <div className="flex items-center gap-2 mb-1">
                                                <span className="font-medium text-slate-900 truncate">{task.title}</span>
                                                <StatusBadge status={task.status} />
