    ...
    <div className="flex min-h-screen flex-col bg-background text-foreground">
      ...
      <main className="flex-1 px-4 sm:px-6 pb-16 sm:pb-24">
        <div className="max-w-4xl mx-auto space-y-14 sm:space-y-20">
          {/* Hero */}
          <div className="pt-8 sm:pt-12"><Breadcrumbs trail={[{ name: "Guides" }, { name: "Design for manufacture, explained", href: "/guides/design-for-manufacture-explained" }]} /></div>
          ...
          <img src="/images/insights/guide-design-for-manufacture-explained.webp" alt="" className="w-full aspect-[16/9] object-cover rounded-2xl border border-border bg-[#faf7f3]" loading="lazy" />
