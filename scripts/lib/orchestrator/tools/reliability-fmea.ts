/**
 * scripts/lib/orchestrator/tools/reliability-fmea.ts
 *
 * TypeScript wrapper for `reliability_fmea.py` — subprocess to repo .venv.
 *
 ...
 *
 * License: free-proprietary. Source: internal://forgeos/reliability
 */
...
export const reliabilityFmeaTool: Tool<any, any> = {
  id: 'reliability-fmea:system',
  name: 'Reliability FMEA + Warranty Cost',
  version: '1.0.0',
  license: 'free-proprietary',
  source_url: 'internal://forgeos/reliability',
  domain: 'mechanical',
  ...
  async invoke(input: any): Promise<ToolResult<any>> {
    ...
    if (proc.status !== 0) {
      return {
        ...
        output: null,
        provenance: {
          source: 'tool:reliability-fmea:system',
    ...
    return {
      ...
      provenance: {
        ...
        tool_source_url: 'internal://forgeos/reliability',
...
registerTool(reliabilityFmeaTool)
