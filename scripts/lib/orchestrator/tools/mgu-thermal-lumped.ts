/**
 * scripts/lib/orchestrator/tools/mgu-thermal-lumped.ts
 *
 * TypeScript wrapper for `mgu_thermal_lumped.py` — subprocess to repo .venv.
...
const PYTHON_SCRIPT = resolve(__dirname, 'python', 'mgu_thermal_lumped.py')
const VENV_PYTHON = resolve(__dirname, '..', '..', '..', '..', '.venv', 'bin', 'python3')

export const MguThermalLumpedTool: Tool<any, any> = {
  id: 'motor:thermal-lumped',
  name: 'MGU Two-Node Winding/Magnet Thermal RC',
  version: '1.0.0',
...
registerTool(MguThermalLumpedTool)
