/**
 * @file page.tsx — Plan redesign "History" surface stub (Phase 3, flag-gated).
 *
 * Flag on: placeholder card. Flag off: redirect to legacy /knowledge.
 */
...
export default async function PlanHistoryPage(): Promise<React.ReactNode> {
    ...
    return (
        <div className="mx-auto max-w-2xl p-8">
            <div className="rounded-lg border border-border bg-card p-6 shadow-sm">
                ...
                <p className="mt-2 text-muted-foreground">History surface</p>
            </div>
        </div>
    )
}
