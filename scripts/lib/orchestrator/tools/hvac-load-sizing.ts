/**
 * scripts/lib/orchestrator/tools/hvac-load-sizing.ts
 *
 * TypeScript wrapper for `hvac_load_sizing.py` — subprocess to repo .venv.
 *
...
const PYTHON_SCRIPT = resolve(__dirname, 'python', 'hvac_load_sizing.py')
const VENV_PYTHON = resolve(__dirname, '..', '..', '..', '..', '.venv', 'bin', 'python3')

export const hvacLoadSizingTool: Tool<any, any> = {
  id: 'hvac:load-sizing',
  name: 'HVAC Cooling Load Sizing',
  version: '1.0.0',
...
registerTool(hvacLoadSizingTool)
