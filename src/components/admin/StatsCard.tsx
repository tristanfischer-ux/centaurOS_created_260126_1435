...
export function StatsCard({
    ...
    return (
        <Card className={cn("border-border shadow-[0_2px_15px_rgba(0,0,0,0.03)] hover:shadow-md hover:-translate-y-0.5 transition-all duration-200", className)}>
            <CardContent className="p-6">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        <div className={cn("p-2.5 rounded-lg bg-slate-50 border border-border", styles.icon)}>
