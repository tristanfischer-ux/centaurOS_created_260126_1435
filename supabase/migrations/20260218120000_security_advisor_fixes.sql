 ...
 *
 * Purpose: Resolve 7 of 8 errors reported by the Supabase Security Advisor:
...
DROP POLICY IF EXISTS "foundry_members_select_own_permissions" ON public.foundry_agent_permissions;
...
DROP POLICY IF EXISTS "foundry_admins_manage_permissions" ON public.foundry_agent_permissions;
...
DROP POLICY IF EXISTS "authenticated_users_read_tiers" ON public.agent_permission_tiers;
...
DROP POLICY IF EXISTS "authenticated_users_read_action_tier_map" ON public.agent_action_tier_map;
