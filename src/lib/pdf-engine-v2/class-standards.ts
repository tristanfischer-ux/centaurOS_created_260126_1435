...
// INTENT (2026-07-15 NinjaPCR): thermocycler had ZERO registry rows on first
// misroute → Risk WARN forever (same lesson as optical_instrument). Lab heaters
// for materials add IEC 61010-2-010 on top of the optical LVD/EMC/61010-1 floor.
const THERMOCYCLER: ClassStandards = {
  product_class: 'thermocycler',
  display_name: 'Benchtop PCR / DNA Amplification Thermocycler',
  compliance_summary:
    'Research-use benchtop thermocyclers are CE-marked laboratory electrical equipment: '
    + 'Low Voltage + EMC + RoHS as the market-access floor, IEC 61010-1 general lab-safety, '
    + 'IEC 61010-2-010 for equipment for the heating of materials (sample block / Peltier / '
    + 'lid heater), and IEC 61326-1 for lab EMC. Clinical IVD / medical-device routes '
    + '(IVDR, IEC 60601) are OUT OF SCOPE unless the brief explicitly requires them.',
  standards: [
    { code: 'LVD 2014/35/EU', title: 'Low Voltage Directive', jurisdiction: 'EU', category: 'electrical', mandatory: true, typical_compliance_cost_gbp: 4_000, typical_lead_time_weeks: 6, applies_because: 'Mandatory CE-marking route for mains-powered laboratory electrical equipment placed on the EU/UK market.' },
    { code: 'EMC 2014/30/EU', title: 'Electromagnetic Compatibility Directive', jurisdiction: 'EU', category: 'emc', mandatory: true, typical_compliance_cost_gbp: 5_000, typical_lead_time_weeks: 6, applies_because: 'Peltier drivers, PWM heaters, MCU clocks and Wi-Fi must not emit or succumb to interference in a lab environment.' },
    { code: 'RoHS 2011/65/EU', title: 'Restriction of Hazardous Substances Directive', jurisdiction: 'EU', category: 'environmental', mandatory: true, typical_compliance_cost_gbp: 2_500, typical_lead_time_weeks: 4, applies_because: 'Restricts Pb/Hg/Cd etc. in electrical equipment; applies to the control PCB, Peltier module and enclosure finishes.' },
    ...
    { code: 'IEC 61010-2-010', title: 'Safety requirements for electrical equipment for measurement, control and laboratory use — Part 2-010: Particular requirements for laboratory equipment for the heating of materials', jurisdiction: 'IEC', category: 'system_safety', mandatory: true, typical_compliance_cost_gbp: 6_000, typical_lead_time_weeks: 10, applies_because: 'Particular requirements for heated sample blocks, lid heaters and Peltier thermal stages that bring materials (PCR reagents) above ambient.' },
    ...
    { code: 'FCC Part 15', title: 'Radio Frequency Devices (unintentional radiators / intentional Wi-Fi)', jurisdiction: 'US', category: 'emc', mandatory: false, typical_compliance_cost_gbp: 5_000, typical_lead_time_weeks: 6, applies_because: 'US market access for digital devices and intentional radiators when the browser UI uses Wi-Fi; required if the brief targets US laboratory sales.' },
  ],
}
