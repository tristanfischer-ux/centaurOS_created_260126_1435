/**
 * scripts/lib/orchestrator/tools/scop-seasonal-efficiency.ts
 *
 * TypeScript wrapper for `scop_seasonal_efficiency.py` — subprocess to repo .venv.
 *
...
const PYTHON_SCRIPT = resolve(__dirname, 'python', 'scop_seasonal_efficiency.py')
const VENV_PYTHON = resolve(__dirname, '..', '..', '..', '..', '.venv', 'bin', 'python3')

export const scopSeasonalEfficiencyTool: Tool<any, any> = {
  id: 'scop:seasonal',
  name: 'SCOP Seasonal Efficiency EN14825',
  version: '1.0.0',
...
registerTool(scopSeasonalEfficiencyTool)
