    ...
    if (variant === "compact") {
        return (
            <>
                ...
                >
                    <div className="flex items-center justify-between p-4 rounded-lg border border-border bg-background hover:bg-foundry-50/30 hover:border-foundry-300 transition-colors">
