  ...
  return (
    <div>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pb-4 border-b border-slate-100">
        <div className="min-w-0 flex-1">
          <div className={typography.pageHeader}>
            ...
            <h1 className={typography.h1}>Deliverables</h1>
          </div>
          <p className={typography.pageSubtitle}>
            Documents, reports, and emails generated by your agent workflows
          </p>
        </div>
      </div>
      ...
      <SpecialistBriefingHero
        ...
        narrative={null}
        fallbackMessage="Your deliverables hub. All documents, reports, and emails generated by your agent workflows in one place."
        isLoading={false}
        severity="success"
