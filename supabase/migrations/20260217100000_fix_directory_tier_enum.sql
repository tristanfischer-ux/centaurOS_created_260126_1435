-- ═══════════════════════════════════════════════════════════════════════
-- Migration: Fix directory RPC tier enum values
--
-- Purpose: The get_directory_experts and get_directory_expert_by_slug
-- functions referenced invalid supplier_tier enum values ('verified',
-- 'premium'). The actual enum values are: verified_partner, approved,
-- pending, suspended.
--
-- Fixes: "invalid input value for enum supplier_tier: 'verified'"
-- ═══════════════════════════════════════════════════════════════════════


-- ═══ Fix get_directory_experts ══════════════════════════════════════════
...
-- ═══ Fix get_directory_expert_by_slug ═══════════════════════════════════
