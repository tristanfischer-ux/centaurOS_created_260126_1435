...
function MissionEnvelopeSvg(): React.ReactElement {
    return (
        <svg className="envelope" viewBox="0 0 500 240" xmlns="http://www.w3.org/2000/svg">
            ...
            <text x="68" y="24" fontFamily="Inter, sans-serif" fontSize="10.5" fontWeight="700" fill="#1c1917">Performance (indicative)</text>
            <text x="408" y="218" fontFamily="Inter, sans-serif" fontSize="10.5" fontWeight="700" fill="#1c1917">Duration (indicative)</text>
            ...
            {/* Title block */}
            <text x="250" y="20" textAnchor="middle" fontFamily="Inter, sans-serif" fontSize="11" fontWeight="700" fill="#1c1917">MISSION ENVELOPE · generic reference curve</text>
        </svg>
    )
}
