...
const ROWS: CompareRow[] = [
  ...
  { label: 'Hardware Fit', getValue: f => f.attributes.hardware_fit_score != null ? `${Number(f.attributes.hardware_fit_score).toFixed(1)}/10` : '—', getNumeric: f => f.attributes.hardware_fit_score != null ? Number(f.attributes.hardware_fit_score) : null, higherIsBetter: true },
  { label: 'Quality Score', getValue: f => f.attributes.data_quality_score != null ? `${Number(f.attributes.data_quality_score).toFixed(1)}/10` : '—', getNumeric: f => f.attributes.data_quality_score != null ? Number(f.attributes.data_quality_score) : null, higherIsBetter: true },
