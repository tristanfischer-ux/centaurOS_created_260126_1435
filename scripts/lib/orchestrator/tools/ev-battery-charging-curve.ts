/**
 * scripts/lib/orchestrator/tools/ev-battery-charging-curve.ts
 *
 * TypeScript wrapper for `ev_battery_charging_curve.py` — subprocess to repo .venv.
 *
...
const PYTHON_SCRIPT = resolve(__dirname, 'python', 'ev_battery_charging_curve.py')
const VENV_PYTHON = resolve(__dirname, '..', '..', '..', '..', '.venv', 'bin', 'python3')

export const evBatteryChargingCurveTool: Tool<any, any> = {
  id: 'ev-charging-curve:taper',
  name: 'EV Battery Charging Curve Taper',
  version: '1.0.0',
...
registerTool(evBatteryChargingCurveTool)
