...
def seed_assets(resolver: CadAssetResolver) -> list[str]:
    ...
    licensed_family_definitions = [
        ...
        (
            ...
            motor_drivetrain.integrated_drive_case_shell,
            {
                "outer_width": 336.0,
                "outer_depth": 254.0,
                "outer_height": 256.0,
                "wall_thickness": 8.0,
                "motor_bore_diameter": 180.0,
                "motor_bore_depth": 150.0,
                "gear_cavity_diameter": 128.0,
                "gear_cavity_depth": 72.0,
                "flange_thickness": 12.0,
                "mounting_ear_count": 4,
                "ear_width": 28.0,
                "ear_thickness": 14.0,
                "ear_extension": 18.0,
            },
            "internal://component_geometry_types/integrated_drive_case_shell",
            "ForgeOS-source-owned",
        ),
        (
            "laminated_dc_bus_stack",
            motor_drivetrain.laminated_dc_bus_stack,
            {
                "plate_length": 160.0,
                "plate_width": 90.0,
                "layer_count": 4,
                "copper_thickness": 0.8,
                "dielectric_gap": 0.15,
                "terminal_tab_length": 22.0,
                "terminal_tab_width": 14.0,
                "phase_bar_count": 3,
                "bar_spacing": 18.0,
                "edge_margin": 8.0,
            },
            "internal://component_geometry_types/laminated_dc_bus_stack",
            "ForgeOS-source-owned",
        ),
        (
            "vehicle_interface_port_cluster",
            motor_drivetrain.vehicle_interface_port_cluster,
            {
                "plate_width": 180.0,
                "plate_height": 120.0,
                "plate_thickness": 8.0,
                "hv_port_diameter": 42.0,
                "hv_boss_height": 28.0,
                "lv_port_width": 32.0,
                "lv_port_depth": 18.0,
                "lv_boss_height": 16.0,
                "coolant_port_diameter": 16.0,
                "coolant_boss_height": 14.0,
                "coolant_spacing": 36.0,
                "edge_margin": 14.0,
            },
