...
const workshopNavigation = [
    ...
    { name: "CAD Lab", href: "/the-forge/cad-lab", icon: Boxes, tooltip: "Turn any product idea into manufacturing-ready parametric CAD in minutes" },
    ...
    { name: "Saved Outputs", href: "/agents/artifacts", icon: FileOutput, tooltip: "Documents, reports, and emails generated by your agent workflows" },
]
