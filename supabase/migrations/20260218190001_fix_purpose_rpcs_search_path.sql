 ...
 *
 * If db push fails (e.g. migration order), run this file in Supabase Dashboard
 * > SQL Editor, then: npx supabase migration repair 20260218190001 --status applied --linked
 *
