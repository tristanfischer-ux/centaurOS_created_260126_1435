      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="min-w-0 flex-1">
          ...
          <div className={typography.pageHeader}>
            ...
            <h1 className={`${typography.h1} inline-flex items-center gap-1.5`}>Objectives <HelpTooltip content="Objectives and Key Results (OKRs) help you set measurable goals and track progress across your team." /></h1>
          </div>
