...
DROP POLICY IF EXISTS "Users can view own task comment read state" ON task_comment_reads;
DROP POLICY IF EXISTS "Users can mark task comments as read" ON task_comment_reads;
DROP POLICY IF EXISTS "Users can update own task comment read state" ON task_comment_reads;
...
-- Drop existing policies first for idempotency
DROP POLICY IF EXISTS "Foundry members can view objective comments" ON objective_comments;
DROP POLICY IF EXISTS "Foundry members can add objective comments" ON objective_comments;
DROP POLICY IF EXISTS "Users can update own objective comments" ON objective_comments;
DROP POLICY IF EXISTS "Users can delete own objective comments" ON objective_comments;
...
-- Drop existing policies first for idempotency
DROP POLICY IF EXISTS "Users can view own objective comment read state" ON objective_comment_reads;
DROP POLICY IF EXISTS "Users can mark objective comments as read" ON objective_comment_reads;
DROP POLICY IF EXISTS "Users can update own objective comment read state" ON objective_comment_reads;
