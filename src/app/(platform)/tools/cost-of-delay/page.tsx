...
/**
 * Cost of Delay Calculator page.
 *
 * @description Interactive tool that visualizes the financial impact of
 * delaying a launch. Users enter their numbers and instantly see how
 * spending to accelerate delivery creates net savings.
 * Inputs are synced to URL params for shareability.
 */
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pb-4 border-b border-slate-100">
        <div className="min-w-0 flex-1">
          <div className={typography.pageHeader}>
            ...
            <h1 className={typography.h1}>Cost of Delay</h1>
          </div>
          <p className={typography.pageSubtitle}>
            Every month you delay costs you overhead + lost revenue. See if spending to ship faster saves money.
          </p>
        </div>
