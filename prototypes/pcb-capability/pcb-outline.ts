/**
 * @file Arbitrary PCB outline geometry (prototype only).
 ...
 * polygons, irregular paths, internal cut-outs, and mounting holes.
 *
 * Run: npx tsx prototypes/pcb-capability/pcb-outline.ts --selftest
 */
