/**
 * scripts/lib/orchestrator/tools/spindle-thermal.ts
 *
 * TypeScript wrapper for `spindle_thermal.py` — subprocess to repo .venv.
 *
...
const PYTHON_SCRIPT = resolve(__dirname, 'python', 'spindle_thermal.py')
const VENV_PYTHON = resolve(__dirname, '..', '..', '..', '..', '.venv', 'bin', 'python3')

export const spindleThermalTool: Tool<any, any> = {
  id: 'spindle:thermal',
  name: 'Spindle Thermal Sizing',
  version: '1.0.0',
...
registerTool(spindleThermalTool)
