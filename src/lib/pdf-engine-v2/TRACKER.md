...
| **K2** | **Exclude engine-lineage models from judge council — implemented as "never judge with a model in the lineage that generated the content being judged"** | ✅ | duplicate of F9 — already resolved |
