/**
 * scripts/lib/orchestrator/tools/lifecycle-co2.ts
 *
 * TypeScript wrapper for `lifecycle_co2.py` — subprocess to repo .venv.
 *
 ...
 *
 * License: free-proprietary. Source: internal://forgeos/lca
 */
...
const PYTHON_SCRIPT = resolve(__dirname, 'python', 'lifecycle_co2.py')
const VENV_PYTHON = resolve(__dirname, '..', '..', '..', '..', '.venv', 'bin', 'python3')

export const lifecycleCo2Tool: Tool<any, any> = {
  id: 'lifecycle-co2:assessment',
  name: 'Lifecycle CO₂ Assessment',
  version: '1.0.0',
  license: 'free-proprietary',
  source_url: 'internal://forgeos/lca',
  domain: 'standards',
  ...
  async invoke(input: any): Promise<ToolResult<any>> {
    ...
    if (proc.status !== 0) {
      return {
        ...
        output: null,
        provenance: {
          source: 'tool:lifecycle-co2:assessment',
    ...
    return {
      ...
      provenance: {
        ...
        tool_source_url: 'internal://forgeos/lca',
