...
export const REPORT_TEMPLATES: ReportTemplate[] = [
  {
    ...
    defaultSections: [
      ...
      { type: 'completion-trend', enabled: true, order: 3 },
      { type: 'objectives-progress', enabled: true, order: 4 },
      { type: 'team-activity', enabled: true, order: 5 },
      { type: 'blockers-risks', enabled: true, order: 6 },
      { type: 'week-ahead', enabled: true, order: 7 },
    ],
  },
  {
    id: 'board-pack',
    ...
    defaultSections: [
      ...
      { type: 'executive-summary', enabled: true, order: 1 },
      { type: 'key-metrics', enabled: true, order: 2 },
      { type: 'objectives-progress', enabled: true, order: 3 },
      { type: 'completion-trend', enabled: true, order: 4 },
      { type: 'team-activity', enabled: true, order: 5 },
      { type: 'blockers-risks', enabled: true, order: 6 },
      { type: 'week-ahead', enabled: false, order: 7 },
    ],
  },
  {
    id: 'custom',
    ...
    defaultSections: [
      ...
      { type: 'completion-trend', enabled: false, order: 3 },
      { type: 'objectives-progress', enabled: false, order: 4 },
      { type: 'team-activity', enabled: false, order: 5 },
      { type: 'blockers-risks', enabled: false, order: 6 },
      { type: 'week-ahead', enabled: false, order: 7 },
    ],
  },
]
