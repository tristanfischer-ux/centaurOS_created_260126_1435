/**
 * scripts/lib/orchestrator/tools/motor-loss-point.ts
 *
 * TypeScript wrapper for `motor_loss_point.py` — subprocess to repo .venv.
...
const PYTHON_SCRIPT = resolve(__dirname, 'python', 'motor_loss_point.py')
const VENV_PYTHON = resolve(__dirname, '..', '..', '..', '..', '.venv', 'bin', 'python3')

export const MotorLossPointTool: Tool<any, any> = {
  id: 'motor:loss-point',
  name: 'MGU Loss Breakdown at One Operating Point',
  version: '1.0.0',
...
registerTool(MotorLossPointTool)
