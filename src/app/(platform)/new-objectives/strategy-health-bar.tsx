      ...
      {stats.map((stat) => {
        ...
        return (
          <button
            ...
            className={cn(
              'flex items-center gap-2 sm:gap-3 rounded-xl border px-3 py-2.5 sm:px-4 sm:py-3 transition-all duration-200',
          ...
          >
            ...
            <div className="text-left">
              <div className="text-lg sm:text-xl font-semibold tabular-nums text-foreground">
                {stat.value}
              </div>
