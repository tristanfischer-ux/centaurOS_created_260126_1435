...
_INSTRUMENT_PROMPT = (
    ...
    "Expect a quiet, inevitable product: charcoal polymer body, dark recessed display glass "
    "(not a green PCB pretending to be a screen), finger-sized tactile keys, a chunky optical "
    "cube with a sample well, and — on cutaways — a structured interior: source → beam → "
    "cuvette → detector on one axis, plus a main PCB and small cell under the UI deck. "
    "A translucent cutaway shell is intentional.\n\n"
