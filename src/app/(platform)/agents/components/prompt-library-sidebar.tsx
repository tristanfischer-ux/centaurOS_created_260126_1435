...
import { PROMPT_LIBRARY, searchPrompts, getPromptsByCategory } from "../lib/prompts"
        ...
        <div className="w-72 sm:w-80 border-r bg-background flex flex-col h-full absolute top-0 left-0 sm:relative z-30 sm:z-auto shadow-lg sm:shadow-none">
            ...
            <div className="px-4 py-3 border-b">
                <div className="flex flex-wrap gap-1.5">
                    ...
                    {customPrompts.length > 0 && (
                        ...
                        >
                            My Templates ({customPrompts.length})
                        </button>
                    )}
            ...
            <div className="p-3 border-t bg-muted/30">
                <p className="text-[10px] text-muted-foreground text-center">
                    Drag templates onto the canvas to build projects
                </p>
            </div>
        </div>
    )
