...
# ============================================================
print("Building upper body shell...")
...
# ============================================================
print("Adding PCB mounting posts...")
...
# ============================================================
print("Adding ventilation grilles...")
...
# ============================================================
# 16. FINAL ASSEMBLY EXPORT
# ============================================================
print("\n=== Exporting files ===")

# STEP (manufacturing interchange)
print("Exporting STEP...")
cq.exporters.export(body_shell, os.path.join(OUTPUT_DIR, "drone_v2.step"))

# STL (3D printing / visualization)
print("Exporting STL...")
cq.exporters.export(body_shell, os.path.join(OUTPUT_DIR, "drone_v2.stl"))

# SVG engineering views
...
for name, direction in views.items():
    cq.exporters.export(
        body_shell,
        os.path.join(OUTPUT_DIR, f"drone_v2_{name}.svg"),
        opt={
    ...
    print(f"  {name} view exported")

print("\n=== All exports complete ===")
print(f"Files in: {OUTPUT_DIR}")
print("  drone_v2.step  - Manufacturing STEP file")
print("  drone_v2.stl   - 3D print mesh")
print("  drone_v2_*.svg - Engineering drawing views")
