/**
 * scripts/lib/orchestrator/tools/agitation-power.ts
 *
 * TypeScript wrapper for `agitation_power.py` — subprocess to repo .venv.
 *
...
const PYTHON_SCRIPT = resolve(__dirname, 'python', 'agitation_power.py')
const VENV_PYTHON = resolve(__dirname, '..', '..', '..', '..', '.venv', 'bin', 'python3')

export const agitationPowerTool: Tool<any, any> = {
  id: 'agitation:power',
  name: 'Rushton Agitation Power',
  version: '1.0.0',
...
registerTool(agitationPowerTool)
