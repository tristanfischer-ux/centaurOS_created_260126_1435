/**
 * @file PCB toolchain discovery (prototype only).
 * @description Detects the installed KiCad/Atopile/Freerouting toolchain without
 * relying on PATH alone. It prints a machine-readable manifest for a future chain preflight.
 *
 * Run: npx tsx prototypes/pcb-capability/discover-pcb-capability.ts
 */
