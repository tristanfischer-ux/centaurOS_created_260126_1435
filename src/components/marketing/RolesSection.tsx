                ...
                <div className="grid md:grid-cols-3 gap-8">
                    {roles.map((role) => (
                        <div key={role.title} className="group relative bg-background p-8 tech-border tech-border-b min-h-[500px] flex flex-col hover:shadow-lg transition-shadow duration-300">
                            ...
                            {/* Actions */}
                            <div className="pt-8 border-t border flex gap-3 mt-auto">
                                <Link
                                    href="/login"
                                    className="flex-1 bg-muted hover:bg-muted/80 text-foreground py-3 text-center text-xs font-mono font-bold tracking-widest uppercase transition-colors"
                                >
                                    Login
                                </Link>
                                <Link
