...
======================================================
1U/2U/3U/6U structural frames, solar panels, reaction wheels,
magnetorquers, star trackers, patch antennas, deployable antennas,
separation springs, kill switches, and propulsion modules.
"""
...
TIER3_CUBESAT = {
    "cubesat_frame": {
        "function": cubesat_frame,
        "name": "CubeSat Frame / Chassis",
        "category": "structure",
        "default_colour": "#C0C0C0",
        "visual_tags": ["aluminium", "structural", "space"],
        "param_schema": {
            "units": {"type": "integer", "default": 1, "enum": [1, 2, 3, 6], "description": "CubeSat size in U"},
            "rail_w": {"type": "number", "default": 8.5, "unit": "mm"},
        },
    },
    "solar_panel_cubesat": {
        "function": solar_panel_cubesat,
        "name": "CubeSat Solar Panel",
        "category": "power",
        "default_colour": "#191970",
        "visual_tags": ["solar", "photovoltaic", "space"],
        "param_schema": {
            "width": {"type": "number", "default": 100.0, "unit": "mm"},
            "height": {"type": "number", "default": 113.5, "unit": "mm"},
            "cell_rows": {"type": "integer", "default": 3},
            "cell_cols": {"type": "integer", "default": 2},
            "has_hinge": {"type": "boolean", "default": False},
        },
    },
    "reaction_wheel": {
        "function": reaction_wheel,
        "name": "Reaction Wheel Assembly",
        "category": "adcs",
        "default_colour": "#2F4F4F",
        "visual_tags": ["mechanical", "rotating", "space"],
        "param_schema": {
            "housing_w": {"type": "number", "default": 40.0, "unit": "mm"},
            "housing_h": {"type": "number", "default": 20.0, "unit": "mm"},
            "wheel_d": {"type": "number", "default": 35.0, "unit": "mm"},
        },
    },
    "magnetorquer": {
        "function": magnetorquer,
        "name": "Magnetorquer Rod",
        "category": "adcs",
        "default_colour": "#8B0000",
        "visual_tags": ["electromagnetic", "coil", "space"],
        "param_schema": {
            "length": {"type": "number", "default": 70.0, "unit": "mm"},
            "core_d": {"type": "number", "default": 5.0, "unit": "mm"},
            "coil_od": {"type": "number", "default": 10.0, "unit": "mm"},
        },
    },
    "star_tracker": {
        "function": star_tracker,
        "name": "Star Tracker / Sun Sensor",
        "category": "adcs",
        "default_colour": "#1A1A1A",
        "visual_tags": ["optical", "sensor", "space"],
        "param_schema": {
            "base_w": {"type": "number", "default": 30.0, "unit": "mm"},
            "baffle_d": {"type": "number", "default": 20.0, "unit": "mm"},
            "baffle_l": {"type": "number", "default": 25.0, "unit": "mm"},
        },
    },
    "patch_antenna_cubesat": {
        "function": patch_antenna_cubesat,
        "name": "CubeSat Patch Antenna",
        "category": "comms",
        "default_colour": "#DAA520",
        "visual_tags": ["copper", "antenna", "space"],
        "param_schema": {
            "ground_w": {"type": "number", "default": 90.0, "unit": "mm"},
            "patch_w": {"type": "number", "default": 60.0, "unit": "mm"},
        },
    },
    "deployable_antenna": {
        "function": deployable_antenna,
        "name": "Deployable Tape-Spring Antenna",
        "category": "comms",
        "default_colour": "#A0A0A0",
        "visual_tags": ["mechanical", "antenna", "deployable", "space"],
        "param_schema": {
            "canister_w": {"type": "number", "default": 90.0, "unit": "mm"},
            "element_count": {"type": "integer", "default": 4, "enum": [1, 2, 4]},
        },
    },
    "separation_spring": {
        "function": separation_spring,
        "name": "Separation / Deployment Spring",
        "category": "deployment",
        "default_colour": "#A0A0A0",
        "visual_tags": ["steel", "spring", "space"],
        "param_schema": {
            "od": {"type": "number", "default": 8.0, "unit": "mm"},
            "length": {"type": "number", "default": 15.0, "unit": "mm"},
            "coils": {"type": "integer", "default": 6},
        },
    },
    "kill_switch": {
        "function": kill_switch,
        "name": "Deployment Kill Switch",
        "category": "safety",
        "default_colour": "#FF0000",
        "visual_tags": ["electronic", "switch", "space"],
        "param_schema": {
            "body_w": {"type": "number", "default": 10.0, "unit": "mm"},
            "body_h": {"type": "number", "default": 6.0, "unit": "mm"},
        },
    },
    "cold_gas_thruster": {
        "function": cold_gas_thruster,
        "name": "Cold Gas Propulsion Module",
        "category": "propulsion",
        "default_colour": "#708090",
        "visual_tags": ["metal", "pressure", "propulsion", "space"],
        "param_schema": {
            "tank_d": {"type": "number", "default": 30.0, "unit": "mm"},
            "tank_l": {"type": "number", "default": 60.0, "unit": "mm"},
            "nozzle_d": {"type": "number", "default": 5.0, "unit": "mm"},
        },
    },
}
