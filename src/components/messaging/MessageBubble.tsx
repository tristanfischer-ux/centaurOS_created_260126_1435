        ...
        {showTimestamp && (
          <div className={cn(
            ...
            <div className={cn(
              ...
              <span className="text-[10px] text-muted-foreground sm:opacity-0 sm:group-hover:opacity-100 transition-opacity">
            ...
            {isOwn && message.read_at && (
              <span className="text-[10px] text-electric-blue sm:opacity-0 sm:group-hover:opacity-100 transition-opacity">
