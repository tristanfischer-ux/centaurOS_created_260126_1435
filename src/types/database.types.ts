  ...
  public: {
    Tables: {
      ...
      audit_log: {
        ...
        Relationships: [
          {
            foreignKeyName: "audit_log_foundry_id_fkey"
            columns: ["foundry_id"]
            isOneToOne: false
            referencedRelation: "foundries"
            referencedColumns: ["id"]
      ...
      finance_project_transactions: {
        ...
        Relationships: [
          {
            foreignKeyName: "finance_project_transactions_project_id_fkey"
            columns: ["project_id"]
            isOneToOne: false
            referencedRelation: "finance_projects"
            referencedColumns: ["id"]
      ...
      finance_projects: {
        ...
        Relationships: [
          {
            foreignKeyName: "finance_projects_foundry_id_fkey"
            columns: ["foundry_id"]
            isOneToOne: false
            referencedRelation: "foundries"
            referencedColumns: ["id"]
      ...
      investor_alerts: {
        ...
        Relationships: [
          {
            foreignKeyName: "investor_alerts_listing_id_fkey"
            columns: ["listing_id"]
            isOneToOne: false
            referencedRelation: "marketplace_listings"
            referencedColumns: ["id"]
      ...
      investor_news_intel: {
        ...
        Relationships: [
          {
            foreignKeyName: "investor_news_intel_generated_by_user_id_fkey"
          ...
          {
            foreignKeyName: "investor_news_intel_listing_id_fkey"
            columns: ["listing_id"]
            isOneToOne: true
            referencedRelation: "marketplace_listings"
            referencedColumns: ["id"]
      ...
      investor_shortlist: {
        ...
        Relationships: [
          {
            foreignKeyName: "investor_shortlist_listing_id_fkey"
            columns: ["listing_id"]
            isOneToOne: false
            referencedRelation: "marketplace_listings"
            referencedColumns: ["id"]
      ...
      quote_requests: {
        ...
        Relationships: [
          {
            foreignKeyName: "quote_requests_foundry_id_fkey"
            columns: ["foundry_id"]
            isOneToOne: false
            referencedRelation: "foundries"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      search_investors_sorted: {
        Args: {
          ...
          filter_bvca_only?: boolean
          filter_cheque_max?: number
          filter_cheque_min?: number
          filter_firm_types?: string[]
          filter_geo_focus?: string[]
          filter_hq_city?: string
          filter_min_hardware_fit?: number
      ...
      search_portfolio_companies_deduped: {
        Args: {
          p_limit?: number
          p_offset?: number
          p_query?: string
