/**
 * scripts/lib/orchestrator/tools/link-budget-rf.ts
 *
 * TypeScript wrapper for `link_budget_rf.py` — subprocess to repo .venv.
 *
...
const PYTHON_SCRIPT = resolve(__dirname, 'python', 'link_budget_rf.py')
const VENV_PYTHON = resolve(__dirname, '..', '..', '..', '..', '.venv', 'bin', 'python3')

export const linkBudgetRfTool: Tool<any, any> = {
  id: 'link-budget:rf',
  name: 'RF Link Budget Friis + Atm',
  version: '1.0.0',
