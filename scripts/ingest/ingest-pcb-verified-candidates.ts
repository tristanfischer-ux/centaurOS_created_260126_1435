...
export const PCB_VERIFIED_CANDIDATES: readonly PcbVerifiedCandidate[] = [
  ...
  {
    partName: 'NinjaPCR reference 1000 uF 25 V bulk capacitor candidate',
    manufacturer: 'Panasonic Industry',
    partNumber: 'EEVFK1E102Q',
    componentClass: 'passive_c',
    function: 'candidate for 12 V thermal-stage bulk decoupling after measured ripple-current closure',
    ...
    sourceCommit: '181768d6ec068a6dd68593042167699285744768',
    evidence: 'Panasonic identifies exact MPN EEVFK1E102Q as 1000 uF, 25 V, 12.5 x 13.5 mm polar SMD with 1.1 Arms ripple at 100 kHz and 5000 h endurance at 105 C. It matches frozen NinjaPCR C3 value and D12.5 envelope, but remains a candidate until thermal-stage RMS ripple is derived.',
  },
  {
    partName: 'NinjaPCR reference twin power relay constituent',
    manufacturer: 'Panasonic Industry',
    partNumber: 'ACTP212',
    componentClass: 'relay',
    function: 'twin Form-C relay constituent for bidirectional thermal-load polarity control',
    ...
    sourceCommit: '181768d6ec068a6dd68593042167699285744768',
    evidence: 'Panasonic ASCTB229E identifies exact MPN ACTP212, 12 V coil, twin Form-C eight-pin PCB package and contact ratings. Frozen NinjaPCR v2.3 names ACTP212 and supplies the eight-pin symbol/footprint. This relay is one bridge constituent, not evidence that the complete TEC bridge closes an unknown load.',
  },
  {
    partName: 'NinjaPCR reference TEC power MOSFET constituent',
    manufacturer: 'Infineon Technologies',
    partNumber: 'IRLB3813PBF',
    componentClass: 'power_mosfet',
    function: 'low-side power-switch constituent in the frozen relay/MOSFET thermal stage',
    ...
    sourceCommit: '181768d6ec068a6dd68593042167699285744768',
    evidence: 'Infineon identifies exact MPN IRLB3813PBF in TO-220AB with G-D-S pinout, 30 V VDS and characterised 4.5/10 V on-resistance. Frozen NinjaPCR Q1 uses this exact value and TO220BV land pattern. Suitability remains conditional on TEC current, gate drive and heatsinking.',
  },
  {
    partName: 'NinjaPCR reference 3.3 V linear regulator candidate',
    manufacturer: 'Jiangsu Changjing Electronics Technology',
    partNumber: 'CJT1117B-3.3-G',
    componentClass: 'regulator',
    function: 'gold-family 3.3 V linear regulator candidate, rejected for unproven 12 V Wi-Fi thermal load',
    ...
    sourceCommit: '181768d6ec068a6dd68593042167699285744768',
    evidence: 'JSCJ identifies the exact distributor ordering code CJT1117B-3.3-G and manufacturer family data defines SOT-223 pins 1 GND, 2 OUTPUT/tab, 3 INPUT, 3.3 V and 1 A. Frozen NinjaPCR REG1 names the CJT1117 3.3 V SOT-223 family, but 12 V to 3.3 V at a 500 mA Wi-Fi transient would dissipate 4.35 W and is not thermally closed.',
  },
  {
