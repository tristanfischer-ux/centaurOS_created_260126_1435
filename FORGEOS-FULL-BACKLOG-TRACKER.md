...
| 1.3 | autoPromoteIfComplete surface | *(duplicate of row 1.3 above — already done in `bcb3c748`)* | — | — | — |
| 1.4 | convertBriefToForge structural | *(duplicate of row 1.4 above — already done in `0ed2ccf3`)* | — | — | — |
...
| 3.* | Polish sprint | **21/22 shipped, 1 deferred (154 needs migration)** | see individual rows 137-157 above | pending prod check | Full sprint accounted for on 2026-04-18. 21 items shipped across 30+ commits; 156 Fundability reviewed no-change; 154 module-image carryover deferred pending schema migration. `./scripts/check-design-tokens.sh src/app/(platform)/` PASSES with 22 advisory warnings only. |
