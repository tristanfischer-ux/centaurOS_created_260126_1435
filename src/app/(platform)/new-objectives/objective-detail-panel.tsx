      ...
      <ScrollArea className="flex-1 w-full max-w-full">
        <div className="p-5 space-y-6 w-full max-w-full overflow-hidden">
          ...
          {objective.is_strategic_goal ? (
            <>
              <Separator />
              <Link href={`/strategic-planner/${objective.id}`}>
                <div className="flex items-center gap-3 px-4 py-3 rounded-lg bg-international-orange/5 border border-international-orange/20 hover:bg-international-orange/10 transition-colors cursor-pointer group">
                  <div className="w-8 h-8 rounded-lg bg-international-orange/10 flex items-center justify-center flex-shrink-0">
                    <Map className="w-4 h-4 text-international-orange" />
                  </div>
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-medium text-foreground group-hover:text-international-orange transition-colors">View AI Plan</p>
                    <p className="text-xs text-muted-foreground">Canvas, timeline, resources & risks</p>
                  </div>
                </div>
              </Link>
            </>
            ...
            <>
              <Separator />
              <Link href={`/new-objectives?mode=strategic&upgrade=${objective.id}`}>
                <div className="flex items-center gap-3 px-4 py-3 rounded-lg bg-muted/50 border border-muted hover:bg-muted transition-colors cursor-pointer group">
                  <div className="w-8 h-8 rounded-lg bg-muted flex items-center justify-center flex-shrink-0">
                    <Sparkles className="w-4 h-4 text-muted-foreground group-hover:text-international-orange transition-colors" />
                  </div>
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-medium text-foreground">Generate AI Plan</p>
                    <p className="text-xs text-muted-foreground">Add phases, dependencies & timeline with AI</p>
                  </div>
                </div>
              </Link>
            </>
