...
def main() -> int:
    ...
    state["fpkConcentricGeometry"] = {
        ...
        "airgap_mm": g.airgap_mm,
        "mean_airgap_diameter_mm": g.mean_airgap_diameter_mm,
        "sun_od_mm": g.sun_od_mm,
        "planet_od_mm": g.planet_od_mm,
        "planet_count": g.planet_count,
        "ring_id_mm": g.ring_id_mm,
        "ring_tip_diameter_mm": g.ring_tip_diameter_mm,
        "gear_face_mm": g.gear_face_mm,
        "gear_module_mm": g.gear_module_mm,
