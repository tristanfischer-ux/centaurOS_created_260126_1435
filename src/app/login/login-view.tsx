/**
 * @file login-view.tsx — Client-side login form with hero image
 *
 * @description Full-screen split layout: hero image on left, login form on right.
 * Uses Supabase auth via server action for credential-based login.
 */
...
/**
 * LoginView — Full-screen login page with hero image.
 *
 * @description Split layout: hero image on left (desktop only), login form on right.
 */
