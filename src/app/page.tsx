    ...
    <div className="min-h-screen bg-white text-slate-900">
      ...
      <nav className="bg-white">
        <div className="max-w-7xl mx-auto px-6 py-4 md:py-6 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            <a href="#centaurs" className="text-sm text-slate-600 hover:text-slate-900 uppercase tracking-wider">
              The Centaurs
            </a>
            <a href="#network" className="text-sm text-slate-600 hover:text-slate-900 uppercase tracking-wider">
              The Network
            </a>
      ...
      <section className="relative md:min-h-screen flex flex-col md:flex-row items-center justify-center overflow-hidden bg-white">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center pt-8 md:pt-0">
          {/* System Online Badge */}
          <div className="inline-flex items-center gap-2 mb-6 md:mb-8 px-4 py-2 border border-blue-200 bg-white/80 backdrop-blur-sm">
          ...
          {/* Tagline */}
          <p className="text-slate-700 text-base md:text-xl max-w-3xl mx-auto leading-relaxed">
      ...
      <section id="centaurs" className="py-12 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8">
            {/* Founders */}
            <div className="border border-blue-200 bg-white p-4 sm:p-6 md:p-8 flex flex-col">
              <div className="h-48 md:h-64 mb-4 md:mb-6 bg-slate-50 border border-slate-200 relative overflow-hidden">
                <Image
            ...
            {/* Apprentices */}
            <div className="border border-blue-200 bg-white p-4 sm:p-6 md:p-8 flex flex-col sm:col-span-2 lg:col-span-1">
              <div className="h-48 md:h-64 mb-4 md:mb-6 bg-slate-50 border border-slate-200 relative overflow-hidden">
                <Image
      ...
      {/* THE NETWORK Section */}
      <section id="network" className="py-12 md:py-24 bg-white border-t border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
      ...
      <section id="os" className="py-12 md:py-24 bg-white border-t border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
