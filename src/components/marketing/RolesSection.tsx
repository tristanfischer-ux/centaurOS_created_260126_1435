...
export function RolesSection() {
    return (
        <section className="py-24 bg-white border-t border-slate-100" id="centaurs">
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    {roles.map((role) => (
                        <div key={role.title} className="group relative bg-white p-8 tech-border tech-border-b min-h-[500px] flex flex-col hover:shadow-lg transition-shadow duration-300">
                            {/* Image Container */}
