            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    {networkPartners.map((partner) => (
                        <div key={partner.title} className="group relative bg-background p-8 tech-border tech-border-b min-h-[500px] flex flex-col hover:shadow-lg transition-shadow duration-300">
                            {/* Image Container */}
