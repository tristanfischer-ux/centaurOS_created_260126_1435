            ...
            {attachedFiles.length > 0 && (
                <div className="space-y-1">
                    {attachedFiles.map((file) => (
                        <div
                            key={file.name}
                            className="flex items-center gap-2 px-2.5 py-1.5 rounded-md bg-muted border border-border group"
                        >
                            ...
                            {onRemoveFile && (
                                <button
                                    ...
                                    className="p-0.5 rounded hover:bg-muted text-muted-foreground sm:opacity-0 sm:group-hover:opacity-100 transition-opacity"
                                >
                                    <X className="w-3 h-3" />
                                </button>
                            )}
