...
CREATE INDEX IF NOT EXISTS idx_telegram_prefs_profile ON telegram_preferences(profile_id);
CREATE INDEX IF NOT EXISTS idx_telegram_prefs_briefing ON telegram_preferences(daily_briefing_enabled, daily_briefing_time) 
...
-- Indexes
CREATE INDEX IF NOT EXISTS idx_telegram_ideas_profile ON telegram_ideas(profile_id);
CREATE INDEX IF NOT EXISTS idx_telegram_ideas_status ON telegram_ideas(profile_id, status) WHERE status = 'inbox';
CREATE INDEX IF NOT EXISTS idx_telegram_ideas_created ON telegram_ideas(created_at DESC);
...
-- Indexes
CREATE INDEX IF NOT EXISTS idx_telegram_decisions_profile ON telegram_decisions(profile_id);
CREATE INDEX IF NOT EXISTS idx_telegram_decisions_pending ON telegram_decisions(profile_id, status) WHERE status = 'pending';
CREATE INDEX IF NOT EXISTS idx_telegram_decisions_priority ON telegram_decisions(priority, created_at) WHERE status = 'pending';
CREATE INDEX IF NOT EXISTS idx_telegram_decisions_reference ON telegram_decisions(reference_type, reference_id);
...
CREATE INDEX IF NOT EXISTS idx_telegram_notif_log_dedup ON telegram_notification_log(notification_id) 
    WHERE notification_id IS NOT NULL;
CREATE INDEX IF NOT EXISTS idx_telegram_notif_log_profile ON telegram_notification_log(profile_id, sent_at DESC);
