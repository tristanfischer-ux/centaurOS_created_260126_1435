...
## Self-reinforcing PDF-quality loop (CANONICAL — codified 2026-05-23 after Tristan-flagged wind L20; gate 3 added 2026-05-24; gates 4+5 added 2026-05-24 after BESS L17 council; gates 6+7 added 2026-05-24 after BESS L18 Physics Critic; gate 8 added 2026-05-25 task #122 universal thermal subsystem ambient-derating contract; gate 9 added 2026-05-25 after BESS L22 council)

**The chain is not acceptable until ALL NINE of these audits PASS:**
...
4. Confirm `audit-pdf-run.ts`, `audit-pdf-bom.ts`, `audit-pdf-layout.py`, `parts-spec-validator.ts`, `numeric-claim-drift-detector.ts`, `sizing-vs-design-audit.ts`, `slot-mispin-detector.ts`, `thermal-derating-audit.ts`, AND `brief-constraint-completeness-audit.ts` all exit 0.
