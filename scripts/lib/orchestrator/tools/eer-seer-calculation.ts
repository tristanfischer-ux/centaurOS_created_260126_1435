/**
 * scripts/lib/orchestrator/tools/eer-seer-calculation.ts
 *
 * TypeScript wrapper for `eer_seer_calculation.py` — subprocess to repo .venv.
 *
...
const PYTHON_SCRIPT = resolve(__dirname, 'python', 'eer_seer_calculation.py')
const VENV_PYTHON = resolve(__dirname, '..', '..', '..', '..', '.venv', 'bin', 'python3')

export const eerSeerCalculationTool: Tool<any, any> = {
  id: 'eer-seer:calc',
  name: 'EER/SEER ASHRAE Calculation',
  version: '1.0.0',
...
registerTool(eerSeerCalculationTool)
