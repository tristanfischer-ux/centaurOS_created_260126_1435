-- Fix Daily Pulse Function - Remove non-existent end_date column references
-- The objectives table does not have an end_date column
...
BEGIN
    ...
    SELECT jsonb_build_object(
        ...
        -- FIXED: Removed end_date column references, order by updated_at in subquery
        'objectives', (
