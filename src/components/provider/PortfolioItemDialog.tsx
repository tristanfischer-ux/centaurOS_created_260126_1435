...
export function PortfolioItemDialog({ item, trigger, onSuccess }: PortfolioItemDialogProps) {
                    ...
                    <div className="grid gap-4 py-4">
                        ...
                        <div className="grid gap-2">
                                    ...
                                    {imageUrls.map((url, index) => (
                                        ...
                                        >
                                            ...
                                            <button
                                                ...
                                                className="absolute -top-1 -right-1 w-5 h-5 rounded-full bg-destructive text-destructive-foreground flex items-center justify-center sm:opacity-0 sm:group-hover:opacity-100 transition-opacity"
                                            >
                                                <X className="w-3 h-3" />
                                            </button>
                                        </div>
                            ...
                            <p className="text-xs text-muted-foreground">
                                Add URLs to images showcasing your work
                            </p>
                        </div>
