...
const ROLES = [
  ...
  },
  {
    ...
    tagline:
      "Deploy your skills across multiple ventures. Mentor AI-augmented young talent. Have a more interesting career than any single company could ever offer.",
    benefits: [
  ...
  },
  {
    ...
    tagline:
      "Harness AI tools to be massively productive. Ship real hardware in your first month. Learn from veterans who've done it before.",
    benefits: [
      "Use AI tools to be 10x more productive from day one",
      "Direct mentorship from experienced fractional executives",
      "Ship real products — not classroom exercises",
