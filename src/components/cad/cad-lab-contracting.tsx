/**
 * @file cad-lab-contracting.tsx — Contract document generation for CAD Lab.
 *
...
function generateRfq(
  ...
  lines.push("=".repeat(50))
  lines.push(`Generated by CAD Lab — ForgeOS — ${date}`)
...
function generateNda(projectName: string, buyerName?: string): string {
  ...
  lines.push("")
  lines.push("=".repeat(50))
  lines.push(`Template generated by CAD Lab — ForgeOS — ${date}`)
