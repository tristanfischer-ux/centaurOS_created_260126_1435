...
-- Migration: 20260212300004_seed_tier3_drones
-- ============================================================
-- Seeds 8 domain-specific geometry types for drone components.
...
def propeller_airfoil(params):
    ...
    return prop
$CADQUERY$,
    '{"diameter": {"type": "number", "default": 127.0, "unit": "mm", "description": "5 inch = 127mm"}, "blade_count": {"type": "integer", "default": 2, "enum": [2, 3]}, "hub_d": {"type": "number", "default": 12.0, "unit": "mm"}, "shaft_d": {"type": "number", "default": 5.0, "unit": "mm"}}'::jsonb,
    '[]'::jsonb,
    ARRAY['composite', 'rotating'],
    '#2F2F2F',
    'Propeller with simplified airfoil twist — not flat paddles.',
    TRUE
...
def fpv_camera(params):
    ...
    return cam
$CADQUERY$,
    '{"size": {"type": "number", "default": 19.0, "enum": [14, 19, 28], "unit": "mm"}, "lens_d": {"type": "number", "default": 14.0, "unit": "mm"}}'::jsonb,
    '[]'::jsonb,
    ARRAY['electronic', 'optical'],
    '#1A1A1A',
    'FPV / micro camera module.',
    TRUE
) ON CONFLICT (slug) DO NOTHING;
...
def esc_board(params):
    ...
    return pcb
$CADQUERY$,
    '{"width": {"type": "number", "default": 27.0, "unit": "mm"}, "mounting_pattern": {"type": "number", "default": 20.0, "unit": "mm"}}'::jsonb,
    '[]'::jsonb,
    ARRAY['pcb', 'electronic'],
    '#006400',
    'Electronic Speed Controller PCB.',
    TRUE
) ON CONFLICT (slug) DO NOTHING;
...
def gps_module(params):
    ...
    return gps
$CADQUERY$,
    '{"pcb_w": {"type": "number", "default": 25.0, "unit": "mm"}, "patch_w": {"type": "number", "default": 18.0, "unit": "mm"}}'::jsonb,
    '[]'::jsonb,
    ARRAY['pcb', 'electronic', 'antenna'],
    '#006400',
    'GPS/GNSS module with ceramic patch antenna.',
    TRUE
) ON CONFLICT (slug) DO NOTHING;
...
def lipo_battery_pack(params):
    ...
    return pack
$CADQUERY$,
    '{"length": {"type": "number", "default": 105.0, "unit": "mm"}, "width": {"type": "number", "default": 35.0, "unit": "mm"}, "height": {"type": "number", "default": 32.0, "unit": "mm"}, "cells": {"type": "integer", "default": 4, "enum": [2, 3, 4, 6]}}'::jsonb,
    '[]'::jsonb,
    ARRAY['battery', 'power'],
    '#FFD700',
    'LiPo pouch-cell battery pack (e.g. 4S 1500mAh).',
...
def cylindrical_cell_18650(params):
    ...
    return cell
$CADQUERY$,
    '{"diameter": {"type": "number", "default": 18.0, "unit": "mm"}, "length": {"type": "number", "default": 65.0, "unit": "mm"}}'::jsonb,
    '[]'::jsonb,
    ARRAY['battery', 'power'],
    '#228B22',
    '18650 cylindrical Li-ion cell.',
...
$CADQUERY$,
    '{"antenna_l": {"type": "number", "default": 50.0, "unit": "mm"}, "antenna_d": {"type": "number", "default": 5.0, "unit": "mm"}}'::jsonb,
    '[]'::jsonb,
    ARRAY['metal', 'electrical', 'antenna'],
    '#1A1A1A',
    'SMA antenna (dipole whip or stubby).',
    TRUE
) ON CONFLICT (slug) DO NOTHING;
...
def frame_plate(params):
    ...
    return body
$CADQUERY$,
    '{"width": {"type": "number", "default": 170.0, "unit": "mm"}, "length": {"type": "number", "default": 200.0, "unit": "mm"}, "thickness": {"type": "number", "default": 2.5, "unit": "mm"}}'::jsonb,
    '[]'::jsonb,
    ARRAY['carbon_fibre', 'structural'],
    '#1A1A1A',
    'Carbon fibre frame plate (top or bottom plate).',
    TRUE
) ON CONFLICT (slug) DO NOTHING;
